package com.example.yf.creatorshirt.mvp.ui.view.picker;
...
public class WheelListView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    private void onSelectedCallback() {
        ...
        Log.e("isUserScroll=", "INDEX"+ index +item);
...
//            LogUtils.verbose(this, "itemHeightPixels=" + itemHeightPixels);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.e("wheel", "press down: currentPosition=" + currentPosition);
                break;
            case MotionEvent.ACTION_UP:
                Log.e("wheel","press up: currentItem=" + getSelectedItem());
                break;
        }
        return false;
    }
    ...
    private static class ItemView extends LinearLayout {
        ...
        private void init(Context context) {
            ...
            int paddingTopBottom = DisplayUtil.Dp2Px(context, ITEM_PADDING_TOP_BOTTOM);
            int paddingLeftRight = DisplayUtil.Dp2Px(context, ITEM_PADDING_LEFT_RIGHT);
            setPadding(paddingLeftRight, paddingTopBottom, paddingLeftRight, paddingTopBottom);
            setGravity(Gravity.CENTER);
            int height = DisplayUtil.Dp2Px(context, ITEM_HEIGHT);
            ...
            imageParams.rightMargin = DisplayUtil.Dp2Px(context, ITEM_MARGIN);

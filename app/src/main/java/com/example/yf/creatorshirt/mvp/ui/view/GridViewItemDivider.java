 ...
 */
public class GridViewItemDivider extends RecyclerView.ItemDecoration {

    Paint mVerPaint, mHorPaint;
    Builder mBuilder;


    public GridViewItemDivider(Builder builder) {
        init(builder);
    }
    ...
    public static class Builder {
        ...
        public GridViewItemDivider build() {
            return new GridViewItemDivider(this);
        }

...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = DisplayUtil.Dp2Px(activity, topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = DisplayUtil.Dp2Px(activity, topHeight);
        ...
        int padding = DisplayUtil.Dp2Px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(DisplayUtil.toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = DisplayUtil.Dp2Px(activity, topPadding);
        ...
        submitButton.setTextColor(DisplayUtil.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {

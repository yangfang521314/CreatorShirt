...
public class RecyRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public RecyRefreshHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyRefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
